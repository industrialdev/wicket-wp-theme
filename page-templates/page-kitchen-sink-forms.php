        ...
        <div class="container">
				...
				<form class="wicket-form">
					<div class="wicket-form-field-wrapper">
						...
						<div class="wicket-form-input-wrapper">
					...
					<div class="wicket-form-field-wrapper">
						<label for="date">Date:</label>
						<div class="wicket-form-input-wrapper">
							<input class="error" type="date" id="date" name="date" value="2018-07-22" min="2018-01-01" max="2018-12-31" />
						</div>
						<p class="wicket-form-help-text">Help text</p>
					</div>
					...
					<div class="wicket-form-field-wrapper">
						<label for="date">Date:</label>
						<div class="wicket-form-input-wrapper">
							<input class="success" type="date" id="date" name="date" value="2018-07-22" min="2018-01-01" max="2018-12-31" />
						</div>
						<p class="wicket-form-help-text">Help text</p>
					</div>
