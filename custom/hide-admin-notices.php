...
function hwan_show_dashboard_notices_cb()
{
    ...
    ?>
<label>
	<input type="checkbox" name="hwan_show_dashboard_notices" value="yes"
...
<div class="hwan-settings-container">
	...
	<div class="hwan-message">
		<p>Periodically displaying dashboard notices is essential, as they may provide vital information regarding your
			site's security, updates, and other significant announcements.</p>
	</div>
...
function hwan_enqueue_admin_styles($hook)
{
    ...
    wp_enqueue_style('hwan-admin-styles', plugins_url('admin.css', __FILE__), [], HWAN_PLUGIN_VERSION);
}
