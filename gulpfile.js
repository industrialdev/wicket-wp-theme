const // Package Variables
  ...
  scriptName = 'wicket',
  parentThemePath = '../wicket-wp-theme';
...
function minScripts() {
  return gulp.src(srcPath + assetPath + `/scripts/mingul/${scriptName}.js`)
    //.pipe(gulpIgnore.exclude(adminScripts))
    .pipe(plumber())
    .pipe(concat(scriptName + '.js'))
    //.pipe(insert.wrap('(function($){\n\n', '\n\n})(jQuery);'))
...
function watchTask() {
  ...
  gulp.watch(srcPath + assetPath + '/scripts/' + '*.js', gulp.series(scriptsTaskAdmin, minScriptsAdmin));
}
...
module.exports = {
  ...
  scripts: gulp.series(
    scriptsTask, minScripts, scriptsTaskAdmin, minScriptsAdmin
  ),
  images: gulp.series(
  ...
  default: gulp.series(
    sassTask, minSass, scriptsTask, minScripts, scriptsTaskAdmin, minScriptsAdmin, fontsTask, watchTask,
  ),
  serve: gulp.parallel(
    watchTask,
  ),
  build: gulp.series(
    sassTask, minSass, scriptsTask, minScripts, scriptsTaskAdmin, minScriptsAdmin, imagesTask, iconsTask, fontsTask,
  ),
};
